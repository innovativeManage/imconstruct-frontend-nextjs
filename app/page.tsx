      ...
      <div className={"pt-10"}>
        <section className="min-h-[500px] md:min-h-screen flex justify-center items-center bg-paint bg-fixed bg-center bg-no-repeat bg-cover">
          <div className="flex flex-col justify-left items-left bg-gray-800 bg-opacity-70 w-full p-4">
            ...
            <Link
              href="/contact"
              className="bg-black text-white text-center mt-4 p-2 rounded-lg transition hover:bg-gray-700 w-[150px]"
            >
              Contact Us
            </Link>
          </div>
        ...
        <section className="p-6 border-2 border-black">
          ...
          <div className="flex justify-center">
            <Link
              href="https://forms.gle/8HF4KvzqvndGkL7j8"
        ...
        <div className="min-h-screen flex justify-right items-center bg-maintman bg-fixed bg-no-repeat bg-cover">
          <div className="justify-right items-center bg-gray-800 bg-opacity-70 w-full p-4">
            ...
            <p className="text-white font-bold align-right text-2xl tracking-wider mb-2">
              Property Care
            </p>
            <p className="text-white align-right">
              Maintenance service allows you to easily manage each unit with QR
              code access. It tracks units maintenance, helping to save time and
              money by reducing unit make-ready and turn-over time. It also
              helps to save on contract evaluation costs, which can be time
        ...
        <section className="p-6 border-2 border-black">
          ...
          <div className="flex mb-4 text-black text-lg sm:text-xl md:text-2xl tracking-wide font-bold items-center justify-center">
            We Offer a Range of Services to Meet Your Needs
          </div>
          <p className="text-black mb-4">
            iMaintain offers facilities a high-quality set of maintenance
            services that guarantee a safe and efficient work environment. With
            our experienced professionals and top-grade materials, we provide
            exceptional solutions to all your maintenance needs.
          </p>
          <div className="flex flex-wrap space-x-4 items-center justify-center">
            <div>
              ...
              <p className="text-black font-bold text-center">Repairs</p>
            </div>
        ...
        <section className="min-h-screen flex justify-center items-center bg-maintman2 bg-fixed bg-no-repeat bg-cover">
          <div className="justify-right items-center bg-gray-800 bg-opacity-70 w-full p-4">
            ...
            <p className="text-white align-right mb-4">
              Take the hassle out of facility maintenance with iMaintain! Our
              team of experienced professionals will keep your property in top
              condition, so you can focus on the things that matter most. With
              iMaintain, you can trust that your facility will always be well
              maintained.
            </p>
            <p className="text-white text-3xl align-right">2018</p>
            <p className="text-white text-xl align-right">
